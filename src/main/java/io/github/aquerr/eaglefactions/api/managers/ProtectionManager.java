...
public interface ProtectionManager
{
    ...
    /**
     * Checks if a {@link User} can explode blocks at the given {@link ServerLocation<World>}
    ...
    /**
     * Checks if blocks can explode at the given {@link ServerLocation<World>}
    ...
    /**
     * Checks if a {@link Player} can interact with block at the given location.
    ...
    /**
     * Checks if a {@link Player} can use an item at the given location.
     ...
     */
    ProtectionResult canUseItem(final ServerLocation location, final User player, final ItemStackSnapshot usedItem, final boolean shouldNotify);
}
